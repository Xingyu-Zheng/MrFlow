...
def parse_args():
    parser = argparse.ArgumentParser(description="Minimal Qwen-Image MrFlow demo.")
    ...
    parser.add_argument("--output-dir", default="mrflow_outputs/qwen_image")
...
def main():
    ...
    pipe = QwenImagePipeline.from_pretrained(args.model, torch_dtype=dtype).to(device)
    ...
    stem = f"qwen_image_mrflow_{args.setting}_seed{args.seed}_{args.width}x{args.height}"
