...
from _piflow_pipelines import PiQwenImageImg2ImgPipeline, load_piflow_pipe  # noqa: E402
...
def parse_args():
    parser = argparse.ArgumentParser(description="Minimal Qwen-Image PiFlow + MrFlow demo.")
    ...
    parser.add_argument("--output-dir", default="mrflow_outputs/qwen_image_piflow")
...
def main():
    ...
    stem = f"qwen_image_piflow_mrflow_4plus1_seed{args.seed}_{args.width}x{args.height}"
